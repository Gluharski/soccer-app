...
const NextFixtures = ({ leagueId }) => {
	...
	useEffect(() => {
		...
		fetch(`https://api-football-v1.p.rapidapi.com/v3/fixtures/rounds?league=${leagueId}&season=2022&current=true`, options)
	...
	return (
		<section className='next__fixtures'>
			<h3>Next Fixtures:</h3>
			{nextMatches.slice(0, 5).reverse().map(x => (
